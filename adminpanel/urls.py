...
urlpatterns = [
    ...
    path(
        "consultations/",
        consultance_views.consultation_booking_list,
        name="consultation_booking_list",
    ),
    path(
        "toggle-status/<int:booking_id>/",
        consultance_views.toggle_consultation_status,
        name="toggle_consultation_status",
    ),
    path(
        "product-category-create/",
        product_views.product_category_create_or_update,
    ...
    path(
        ...
        product_views.product_category_list,
        name="product_category_list",
    ),
    path(
        "product-category/delete/<int:pk>/",
        product_views.product_category_delete,
    ...
    path(
        ...
        product_views.product_subcategory_create_or_update,
        name="product_subcategory_create",
    ),  # For create
    path(
        "product-subcategory/<int:pk>/",
        product_views.product_subcategory_create_or_update,
        name="product_subcategory_update",
    ),  # For update
    path(
        "product-subcategory/list/",
        product_views.product_subcategory_list,
        name="product_subcategory_list",
    ),
    path(
        "product-subcategory/delete/<int:pk>/",
        product_views.product_subcategory_delete,
        name="product_subcategory_delete",
    ),
    path(
        "product-designs-create/",
        product_views.product_designs_create_or_update,
        name="product_designs_create",
    ),  # For create
    path(
        "product-designs/<int:pk>/",
        product_views.product_designs_create_or_update,
        name="product_designs_update",
    ),  # For update
    path(
        "product-designs/list/",
        product_views.product_designs_list,
        name="product_designs_list",
    ),
    path(
        "product-designs/delete/<int:pk>/",
        product_views.product_designs_delete,
        name="product_designs_delete",
    ),
    path(
        "product-size-create/",
        product_views.product_size_create_or_update,
        name="product_size_create",
    ),  # For create
    path(
        "product-size/<int:pk>/",
        product_views.product_size_create_or_update,
        name="product_size_update",
    ),  # For update
    path(
        "product-size/list/", product_views.product_size_list, name="product_size_list"
    ),
    path(
        "product-size/delete/<int:pk>/",
        product_views.product_size_delete,
        name="product_size_delete",
    ),
    path(
        "product-create/", product_views.product_create_or_update, name="product_create"
    ),  # For create
    path(
        "product/<int:pk>/",
        product_views.product_create_or_update,
        name="product_update",
    ),  # For update
    path("product/list/", product_views.product_list, name="product_list"),
    path(
        "product/delete/<int:pk>/", product_views.product_delete, name="product_delete"
    ),
    path(
        "product/subcategories/",
        product_views.get_subcategories,
        name="get_subcategories",
    ),
    path(
        "product-image-create/",
        product_views.product_image_create_or_update,
    ...
    path(
        "product-image/list/",
        product_views.product_image_list,
        name="product_image_list",
    ),
    path(
        "product-image/delete/<int:pk>/",
        product_views.product_image_delete,
        name="product_image_delete",
    ),
    path(
        "variants/list/",
        product_views.product_variant_list,
        name="product_variant_list",
    ),
    path(
        "variants/create/",
        product_views.product_variant_create_or_update,
    ...
    path(
        ...
        product_views.product_variant_delete,
    ...
    path("page/dashboard/", page_views.dashboard_page, name="dashboard_page"),
    path("page/consultation/", page_views.consultation_page, name="dashboard_page"),
    path("page/auth/", page_views.login_page, name="auth_page"),
]
